...
The logic combined authentication volume, targeted-user count, and the known service exclusion.

---

## Troubleshooting Method

The troubleshooting process followed a progressive approach:

1. Reduce the failing query.
2. Validate the smallest working query.
3. Rebuild the synthetic dataset.
4. Validate the detection threshold.
5. Add contextual aggregation.
6. Simplify comparison logic when errors appeared.
7. Validate the false-positive candidate.
8. Validate the suspicious candidate.
9. Compare the initial and tuned results.

The main troubleshooting principle was:

    Simplify → Validate → Expand → Validate Again
